            ...
            @if (templeService.siteConfig().enableBooking) {
                  ...
                  <div class="animate-fade-in">
                   ...
                   <div class="animate-fade-in text-center max-w-2xl mx-auto py-8">
                      ...
                      <div class="mt-8 flex justify-center gap-4">
                          <button (click)="printTicket()" class="bg-stone-800 text-white px-6 py-2 themed-rounded font-bold hover:bg-stone-900 flex items-center gap-2">
                ...
                <div class="flex flex-col items-center justify-center py-20 text-center animate-fade-in">
                    <div class="w-24 h-24 bg-stone-100 rounded-full flex items-center justify-center mb-6">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12 text-stone-400"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    </div>
...
export class BookingComponent {
  ...
  async confirmBooking(event: Event) {
    ...
    const booking = {
      ...
      ticketCode: '', // This will be generated by the service
