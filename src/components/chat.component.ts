...
@Component({
  ...
  template: `
    ...
    <!-- Fix: Use @if control flow instead of *ngIf -->
    @if (isOpen()) {
      <div class="fixed bottom-6 right-6 w-[90vw] md:w-96 h-[500px] bg-white rounded-xl shadow-2xl flex flex-col z-[100] border border-amber-600 overflow-hidden animate-fade-in-up">
        <!-- Header -->
